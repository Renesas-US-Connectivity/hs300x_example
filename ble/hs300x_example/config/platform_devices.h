...
#define I2C_MASTER_SCL_PIN  HW_GPIO_PIN_27
#define I2C_MASTER_SDA_PIN  HW_GPIO_PIN_28

#define I2C_SLAVE_ADDRESS    (0x44)

#define I2C_CTRLR_INSTANCE       (HW_I2C1)

#define HS300x_POWER_GPIO_PORT HW_GPIO_PORT_1
#define HS300x_POWER_GPIO_PIN  HW_GPIO_PIN_1
